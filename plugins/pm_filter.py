...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/movie_hub2_0"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/movie_hub2_0")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/saheer_bot_support'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/Series_Movie_Hub_2_0')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Hub 🎬', url=f'https://t.me/Series_Movie_Hub_2_0')
            ]
            ]
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/saheer_bot_support'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/movie_hub2_0')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Hub 🎬', url=f'https://t.me/Series_Movie_Hub_2_0')
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/saheer_bot_support'),
            InlineKeyboardButton('Movie Hub ⭕️', url='https://t.me/movie_hub2_0')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/satus_link_1'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Movie", url="https://t.me/movie_hub2_0"),
        InlineKeyboardButton("Series ⭕️", url="https://t.me/Series_Movie_Hub_2_0")
    ])
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/bot_update_tech_yt")
    ])
